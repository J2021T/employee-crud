...
// const addEmployee = () => {
//   db.query(`select r.role_id, r.job_title from roles r`, (err, result) => {
//       if (err) throw err;
...
//                     type: 'list',
//                     name: 'empl_id',
//                     message: 'Pick the employee you just entered so we can add their manager.',
//                     choices: managers
//                 },
//                 {
//                     type: 'list',
...
//             ])
//             .then(data => {
//                 const params = [data.mngr_id, data.empl_id];
